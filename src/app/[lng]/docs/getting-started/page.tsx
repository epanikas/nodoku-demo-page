...
export default async function Page({params}: { params: Promise<{ lng: string }> }): Promise<JSX.Element> {
    ...
    const skin: NdPageSkin = parseYamlContentAsSkin(fs.readFileSync("./public/site/docs/getting-started.yaml").toString());
    const content: NdContentBlock[] = parseMarkdownAsContent(fs.readFileSync("./public/site/docs/getting-started.md").toString(), "en", "getting-started")
