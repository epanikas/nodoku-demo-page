...
export default async function Page({params}: { params: Promise<{ lng: string }> }): Promise<JSX.Element> {
    ...
    const skin: NdPageSkin = parseYamlContentAsSkin(fs.readFileSync("./public/site/readme/attributions.yaml").toString());
    const content: NdContentBlock[] = parseMarkdownAsContent(fs.readFileSync("./public/site/readme/attributions.md").toString(), "en", "attributions")
